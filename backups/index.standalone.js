...
/**
 * Analytical MCP Server - Standalone Version
 * Implements the MCP protocol directly without using the SDK
 */
...
console.error('Starting Analytical MCP Server - Standalone Version');
