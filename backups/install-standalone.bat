@echo off
echo Applying standalone MCP server fix to analytical-mcp-server...
...
:: Replace index.js with our standalone version
echo Replacing index.js with standalone version
copy build\index.standalone.js build\index.js

:: Update the Claude Desktop App configuration
echo.
echo Fix applied - please relaunch Claude to use the fixed server
echo.
echo IMPORTANT: This is a completely standalone implementation with two tools:
