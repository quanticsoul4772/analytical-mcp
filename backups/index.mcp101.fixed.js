...
/**
 * Initialize the MCP server with appropriate capabilities for SDK 1.0.1
 */
function initializeServer() {
  ...
  // Create the server with SDK 1.0.1 compatibility
  ...
  // Add capabilities manually for SDK 1.0.1
  server.capabilities = {
    tools: {
