...
/**
 * Analytical MCP Server - Protocol Fixed Version
...
console.error('Starting Analytical MCP Server - Protocol Fixed Version');
...
// Override the onRequest method to handle all requests
